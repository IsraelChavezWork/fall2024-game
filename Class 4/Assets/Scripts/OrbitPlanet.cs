...
public class OrbitPlanet : MonoBehaviour
{
    ...
    public void SetOrbitDistance(float distnace){
        planetProper.transform.localPosition = new Vector3(0, distnace, 0);
    }
    ...
    public void RandomizeColor(){
        ...
        sr.color = Color.HSVToRGB(Random.Range(0f,1f),0.5f, 0.5f);
    }
